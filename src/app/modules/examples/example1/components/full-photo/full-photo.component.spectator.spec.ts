...
describe('FullPhotoComponent with spectator', () => {
  ...
  it('renders the photo information', () => {
    ...
    expect(spectator.query(byTestId('full-photo-ownername'))).toHaveText(photo1.ownername);
    expect(spectator.query(byTestId('full-photo-datetaken'))).toHaveText(photo1.datetaken);
